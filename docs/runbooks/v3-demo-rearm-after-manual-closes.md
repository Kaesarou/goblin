...
- Le conteneur démarre dans `scripts.demo_rearm_after_manual_closes`, sans lancer V3 ni émettre d'ordre broker tant que le compte n'est pas à plat.
